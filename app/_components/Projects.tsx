    ...
    <section id="projects" className={`${league1.className} p-2 md:p-6 mt-8 lg:mt-6 `}>
      ...
      <div className="mt-6">
        {work.map((item, index) => (
          ...
          >
            <div className="">
              <p className="text-slate-100 font-semibold text-lg flex justify-between">{item.title} <span className="flex gap-4"><Link href={item.gitlink}><GitHub/></Link><Link href={item.wlink}><Visibility/></Link></span></p>
